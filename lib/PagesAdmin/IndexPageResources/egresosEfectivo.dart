...
class EgresosEefectivo extends StatefulWidget {
  @override
  _EgresosEefectivoState createState() => _EgresosEefectivoState();
}

class _EgresosEefectivoState extends State<EgresosEefectivo> {
  File _image;
  File _image2;
  File _image3;
  File _image4;
      ...
      child: Container(
        child: TextFormField(
          ...
          decoration: InputDecoration(
            ...
            labelText: 'Concepto del Egreso en Flujo de Efectivo',
