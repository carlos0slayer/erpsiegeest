...
class ingresoEfectivo extends StatefulWidget {
  @override
  _ingresoEfectivoState createState() => _ingresoEfectivoState();
}

class _ingresoEfectivoState extends State<ingresoEfectivo> {
  File _image;
  File _image2;
  File _image3;
  File _image4;
        ...
        child: TextFormField(
          ...
          decoration: InputDecoration(
            ...
            enabledBorder: OutlineInputBorder(
                ...
                borderRadius: BorderRadius.circular(20.0)),
            hintText: 'Concepto en flujo de efectivo',
