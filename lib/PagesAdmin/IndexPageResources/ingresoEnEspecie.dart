...
class ingresoEspecie extends StatefulWidget {
  @override
  _ingresoEspecieState createState() => _ingresoEspecieState();
}

class _ingresoEspecieState extends State<ingresoEspecie> {
  File _image;
  File _image2;
  File _image3;
  File _image4;
        ...
        child: TextFormField(
          ...
          decoration: InputDecoration(
            ...
            enabledBorder: OutlineInputBorder(
                ...
                borderRadius: BorderRadius.circular(20.0)),
            hintText: 'Concepto del ingreso en especie',
